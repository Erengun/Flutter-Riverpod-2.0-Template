...
String _$themeBoxHash() => r'fb2670fe0c9bb1a827dd28a3e2467f2cd0a5aef1';

/// See also [themeBox].
@ProviderFor(themeBox)
final themeBoxProvider = AutoDisposeFutureProvider<Box<ThemeUiModel>>.internal(
  themeBox,
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef ThemeBoxRef = AutoDisposeFutureProviderRef<Box<ThemeUiModel>>;
