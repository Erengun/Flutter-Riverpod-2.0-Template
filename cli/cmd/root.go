...
Write 'init' in the terminal to start the process.
`,
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.Flutter-Riverpod-2.0-Template.yaml)")
